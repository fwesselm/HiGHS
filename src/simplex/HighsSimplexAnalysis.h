...
struct TranStageAnalysis {
  ...
  HighsInt num_decision_ = 0;
  HighsInt num_wrong_original_sparse_decision_ = 0;
  HighsInt num_wrong_original_hyper_decision_ = 0;
  HighsInt num_wrong_new_sparse_decision_ = 0;
  HighsInt num_wrong_new_hyper_decision_ = 0;
};
...
class HighsSimplexAnalysis {
 ...
 private:
  ...
  struct AnIterOpRec {
    double AnIterOpHyperCANCEL = 0.0;
    double AnIterOpHyperTRAN = 0.0;
    HighsInt AnIterOpRsDim = 0;
    HighsInt AnIterOpNumCa = 0;
    HighsInt AnIterOpNumHyperOp = 0;
    HighsInt AnIterOpNumHyperRs = 0;
    double AnIterOpSumLog10RsDensity = 0.0;
    HighsInt AnIterOpRsMxNNZ = 0;
  ...
  struct AnIterTraceRec {
    double AnIterTraceTime = 0.0;
    double AnIterTraceMulti = 0.0;
    double AnIterTraceDensity[kNumSimplexNlaOperation];
    double AnIterTraceCostlyDse = 0.0;
    HighsInt AnIterTraceIter = 0;
    HighsInt AnIterTrace_simplex_strategy = 0;
    HighsInt AnIterTrace_edge_weight_mode = 0;
  };
