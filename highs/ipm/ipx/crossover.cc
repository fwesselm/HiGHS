...
void Crossover::PushAll(Basis* basis, Vector& x, Vector& y, Vector& z,
  ...
  h_logging_stream << Textline("Primal residual before push phase:")
  ...
  h_logging_stream << Textline("Number of dual pushes required:")
  ...
  h_logging_stream << Textline("Number of primal pushes required:")
