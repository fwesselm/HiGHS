...
struct HighsOptionsStruct {
  ...
  double infinite_cost = 0.0;
  double infinite_bound = 0.0;
  double small_matrix_value = 0.0;
  double large_matrix_value = 0.0;
  double primal_feasibility_tolerance = 0.0;
  double dual_feasibility_tolerance = 0.0;
  double ipm_optimality_tolerance = 0.0;
  double objective_bound = 0.0;
  double objective_target = 0.0;
  HighsInt threads = 0;
  HighsInt user_bound_scale = 0;
  HighsInt user_cost_scale = 0;
  HighsInt highs_debug_level = 0;
  HighsInt highs_analysis_level = 0;
  HighsInt simplex_strategy = 0;
  HighsInt simplex_scale_strategy = 0;
  HighsInt simplex_crash_strategy = 0;
  HighsInt simplex_dual_edge_weight_strategy = 0;
  HighsInt simplex_primal_edge_weight_strategy = 0;
  HighsInt simplex_iteration_limit = 0;
  HighsInt simplex_update_limit = 0;
  HighsInt simplex_min_concurrency = 0;
  HighsInt simplex_max_concurrency = 0;

  std::string log_file = "";
  bool write_model_to_file = false;
  bool write_solution_to_file = false;
  HighsInt write_solution_style = 0;
  HighsInt glpsol_cost_row_location = 0;
  ...
  HighsInt ipm_iteration_limit = 0;

  // Options for PDLP solver
  bool pdlp_native_termination = false;
  bool pdlp_scaling = false;
  HighsInt pdlp_iteration_limit = 0;
  HighsInt pdlp_e_restart_method = 0;
  double pdlp_d_gap_tol = 0.0;

  // Options for QP solver
  HighsInt qp_iteration_limit = 0;
  HighsInt qp_nullspace_limit = 0;

  // Advanced options
  HighsInt log_dev_level = 0;
  bool log_githash = false;
  bool solve_relaxation = false;
  bool allow_unbounded_or_infeasible = false;
  bool use_implied_bounds_from_presolve = false;
  bool lp_presolve_requires_basis_postsolve = false;
  bool mps_parser_type_free = false;
  HighsInt keep_n_rows = 0;
  HighsInt cost_scale_factor = 0;
  HighsInt allowed_matrix_scale_factor = 0;
  HighsInt allowed_cost_scale_factor = 0;
  HighsInt ipx_dualize_strategy = 0;
  HighsInt simplex_dualize_strategy = 0;
  HighsInt simplex_permute_strategy = 0;
  HighsInt max_dual_simplex_cleanup_level = 0;
  HighsInt max_dual_simplex_phase1_cleanup_level = 0;
  HighsInt simplex_price_strategy = 0;
  HighsInt simplex_unscaled_solution_strategy = 0;
  HighsInt presolve_reduction_limit = 0;
  HighsInt restart_presolve_reduction_limit = 0;
  HighsInt presolve_substitution_maxfillin = 0;
  HighsInt presolve_rule_off = 0;
  bool presolve_rule_logging = false;
  bool simplex_initial_condition_check = false;
  bool no_unnecessary_rebuild_refactor = false;
  double simplex_initial_condition_tolerance = 0.0;
  double rebuild_refactor_solution_error_tolerance = 0.0;
  double dual_steepest_edge_weight_error_tolerance = 0.0;
  double dual_steepest_edge_weight_log_error_threshold = 0.0;
  double dual_simplex_cost_perturbation_multiplier = 0.0;
  double primal_simplex_bound_perturbation_multiplier = 0.0;
  double dual_simplex_pivot_growth_tolerance = 0.0;
  double presolve_pivot_threshold = 0.0;
  double factor_pivot_threshold = 0.0;
  double factor_pivot_tolerance = 0.0;
  double start_crossover_tolerance = 0.0;
  bool less_infeasible_DSE_check = false;
  bool less_infeasible_DSE_choose_row = false;
  bool use_original_HFactor_logic = false;
  bool run_centring = false;
  HighsInt max_centring_steps = 0;
  double centring_ratio_tolerance = 0.0;

  // Options for iCrash
  bool icrash = false;
  bool icrash_dualize = false;
  std::string icrash_strategy = "";
  double icrash_starting_weight = 0.0;
  HighsInt icrash_iterations = 0;
  HighsInt icrash_approx_iter = 0;
  bool icrash_exact = false;
  bool icrash_breakpoints = false;

  // Options for MIP solver
  bool mip_detect_symmetry = false;
  bool mip_allow_restart = false;
  HighsInt mip_max_nodes = 0;
  HighsInt mip_max_stall_nodes = 0;
  HighsInt mip_max_leaves = 0;
  HighsInt mip_max_improving_sols = 0;
  HighsInt mip_lp_age_limit = 0;
  HighsInt mip_pool_age_limit = 0;
  HighsInt mip_pool_soft_limit = 0;
  HighsInt mip_pscost_minreliable = 0;
  HighsInt mip_min_cliquetable_entries_for_parallelism = 0;
  HighsInt mip_report_level = 0;
  double mip_feasibility_tolerance = 0.0;
  double mip_rel_gap = 0.0;
  double mip_abs_gap = 0.0;
  double mip_heuristic_effort = 0.0;
  double mip_min_logging_interval = 0.0;
#ifdef HIGHS_DEBUGSOL
  std::string mip_debug_solution_file = "";
#endif
  bool mip_improving_solution_save = false;
  bool mip_improving_solution_report_sparse = false;
