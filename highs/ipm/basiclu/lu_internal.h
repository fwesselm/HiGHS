...
struct lu {
  ...
  lu_int *Rbegin, *eta_row;
  lu_int* rowcount_blink;
  lu_int* iwork1;
  lu_int* Wbegin;
  lu_int* Lbegin; /* + Wbegin reused */
  lu_int* Wend;
  lu_int* Ltbegin; /* + Wend   reused */
  lu_int* Wflink;
  lu_int* Ltbegin_p; /* + Wflink reused */
  lu_int* Wblink;
  lu_int* p; /* + Wblink reused */
  lu_int* pinv;
  lu_int* pmap;
  lu_int* qinv;
  lu_int* qmap;
...
lu_int lu_load(struct lu* this, lu_int* istore, double* xstore, lu_int* Li,
               double* Lx, lu_int* Ui, double* Ux, lu_int* Wi, double* Wx);

lu_int lu_save(const struct lu* this, lu_int* istore, double* xstore,
               lu_int status);
...
lu_int lu_setup_bump(struct lu* this, const lu_int* Bbegin, const lu_int* Bend,
                     const lu_int* Bi, const double* Bx);

lu_int lu_singletons(struct lu* this, const lu_int* Bbegin, const lu_int* Bend,
                     const lu_int* Bi, const double* Bx);

void lu_solve_dense(struct lu* this, const double* rhs, double* lhs,
                    char trans);

lu_int lu_solve_for_update(struct lu* this, const lu_int nrhs,
                           const lu_int* irhs, const double* xrhs, lu_int* nlhs,
                           lu_int* ilhs, double* xlhs, char trans);

void lu_solve_sparse(struct lu* this, const lu_int nrhs, const lu_int* irhs,
                     const double* xrhs, lu_int* nlhs, lu_int* ilhs,
...
lu_int lu_solve_symbolic(const lu_int m, const lu_int* begin, const lu_int* end,
                         ...
                         const lu_int* irhs, lu_int* ilhs, lu_int* pstack,
                         lu_int* marked, const lu_int M);
...
lu_int lu_solve_triangular(const lu_int nz_symb, const lu_int* pattern_symb,
                           ...
                           double* lhs, lu_int* pattern, lu_int* flops);
...
void lu_matrix_norm(struct lu* this, const lu_int* Bbegin, const lu_int* Bend,
                    const lu_int* Bi, const double* Bx);

void lu_residual_test(struct lu* this, const lu_int* Bbegin, const lu_int* Bend,
                      const lu_int* Bi, const double* Bx);
