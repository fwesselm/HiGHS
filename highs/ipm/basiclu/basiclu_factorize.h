lu_int basiclu_factorize(lu_int istore[], double xstore[], lu_int Li[],
                         double Lx[], lu_int Ui[], double Ux[], lu_int Wi[],
                         double Wx[], const lu_int Bbegin[],
                         const lu_int Bend[], const lu_int Bi[],
                         const double Bx[], lu_int c0ntinue);
...
Parameters:
    ...
    xstore[BASICLU_TIME_LIMIT]
        ...
        xstore[BASICLU_TIME_LIMIT]. Default: infinity
